    ...
    <div className="bg-white rounded-lg overflow-hidden shadow-sm hover:shadow-xl transition-all duration-300 group border border-gray-100 flex flex-col max-h-80">
      ...
      <div className="p-0.5 flex flex-col grow">
        ...
        <button
          onClick={handleQuickAddClick}
          disabled={isStockOut}
          className={`w-full py-1.5 rounded-sm transition-all duration-300 flex items-center justify-center gap-1.5 font-semibold text-xs shadow-md transform ${isStockOut
                ...
                {product.inventoryRef.map((item: any) => {
                  ...
                  return (
                    <button
                      ...
                      className={`p-0.5 rounded-lg border-2 transition-all text-sm font-semibold relative ${selectedInventory === item._id
